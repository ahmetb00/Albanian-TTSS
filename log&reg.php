    ...
    <div class="container">
      ...
      <div class="cover">
        <div class="front">
          ...
          <div class="text">
            <span class="text-1">You just write and <br> and we speak for you!</span>
        ...
        <div class="back">
          ...
          <div class="text">
            <span class="text-11">Start miles of journeys <br> with one step</span>
            <span class="text-22">Let's get started</span>
          </div>
        </div>
      </div>
      <div class="forms">
